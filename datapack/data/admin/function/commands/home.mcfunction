$execute unless data storage admin:home id."$(id)".pos unless data storage admin:home id."$(id)".dim run tellraw @s {"text":"404","color":"gold","italic":false,"bold":true}
$execute unless data storage admin:home id."$(id)".pos unless data storage admin:home id."$(id)".dim run return fail
...
$title @s actionbar {"text":"Home'a ışınlandın...","color":"aqua"}
