...
execute in minecraft:overworld as @e[type=minecraft:interaction,tag=gulceos_load.dp,limit=1] at @s run execute as @e[type=minecraft:marker,tag=glc,limit=1] at @s run say [DP] Loading...
