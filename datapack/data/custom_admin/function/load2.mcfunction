...
function gulce_adminpower_addons:config/load3 {"load_second":"22","loop":"1",DisplayRules:"0b","cl_second":"50","diamond_to_emerald_recipe":"take","level":1,"TriggerHelpCommand":"remove","load":"empty",time:"day",log:"1",difficulty:"easy",xp:"empty"}
...
tellraw @a[tag=op] ["["," ",{"text":"Stop","click_event":{"action":"run_command","command":"/function main:stop"},"hover_event":{"action":"show_text","value":"Click to Stop!"}}," ","]"]
tellraw @a[tag=mod] ["["," ",{"text":"Stop","click_event":{"action":"run_command","command":"/function main:stop"},"hover_event":{"action":"show_text","value":"Click to Stop!"}}," ","]"]
